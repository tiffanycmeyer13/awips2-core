 ...
 * Feb 07, 2011  7948     bkowal    added a public method to get the direction.
...
public class GriddedStreamlineDisplay extends GriddedContourDisplay {
    ...
    public GriddedStreamlineDisplay(IMapDescriptor descriptor,
            String resourceId, GridGeometry2D gridGeometry, FloatBuffer ufb,
            FloatBuffer vfb) {
        super(descriptor, resourceId, gridGeometry, ufb);
        this.vSource = new GeographicDataSource(vfb, gridGeometry);
    }

    public GriddedStreamlineDisplay(IMapDescriptor descriptor,
            String resourceId, GridGeometry2D gridGeometry, DataSource ufb,
            DataSource vfb) {
        super(descriptor, resourceId, gridGeometry, ufb);
        this.vSource = vfb;
    }
