 ...
 * Oct 12, 2022 8946       mapeters    Update to support map and height subclasses
 *
 * </pre>
 *
 * @author randerso
 *
 */
public abstract class ScaleButtonHandler extends AbstractGlobalsButtonHandler
     ...
     *
     * @param globalsId
     *            global ID of the scale property that this deals with
     */
    public ScaleButtonHandler(String globalsId) {
        super(globalsId);
    }
    ...
    protected void updateGlobalValue(IWorkbenchWindow changedWindow,
        ...
        element.setTooltip(getTooltip(scale));
    }

    /**
     * Get the tooltip to show when mousing over the button for the given scale
     * value.
     *
     * @param scale
     *            the current scale
     ...
     */
    protected abstract String getTooltip(String scale);
}
