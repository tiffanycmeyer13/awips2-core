 ...
 * May 12, 2014  3154     rjpeter   Remove reclaimSpace, postgres 9.2 autovacuum
 *                                  sufficient.
...
public class StatsDao extends SessionManagedDao<Integer, StatsRecord> {
     ...
     */
    public StatsDao(IDaoConfigFactory daoConfigFactory) {
    ...
    public Calendar retrieveMinTime(String eventType) {
        return supplyInTransaction(() -> {
            ...
            List<Object> results = this.executeHQLQuery(hql, "eventType",
                    eventType);
     ...
     */
    public List<StatsRecord> retrieveRecords(String eventType, Calendar minTime,
            Calendar maxTime) {
        return supplyInTransaction(() -> {
