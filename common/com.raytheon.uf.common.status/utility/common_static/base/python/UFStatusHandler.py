...
# ------------- -------- --------- --------------------------------------------
# Jul 19, 2009           njensen   Initial Creation.
# Feb 13, 2015  4038     rferrel   Force root logging to NOTSET
# Apr 25, 2015  4952     njensen   Updated for new JEP API
# Dec 10, 2021  8342     randerso  Updated to use logging constants
#                                  Made logging.DEBUG map to Priority.VERBOSE
#
##
